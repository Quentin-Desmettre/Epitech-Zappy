...
void Graphic::initMenu()
{
    ...
    _textures.emplace_back(LoadTextureFromImage(_menuImage[BUTTON_CONTROLS]));
    _positions.emplace_back(Vector2{30, 30});
    _functions.emplace_back("help");

    _textures.emplace_back(LoadTextureFromImage(_menuImage[MENU]));
    _positions.emplace_back(Vector2{0, 0});
    _functions.emplace_back("none");
